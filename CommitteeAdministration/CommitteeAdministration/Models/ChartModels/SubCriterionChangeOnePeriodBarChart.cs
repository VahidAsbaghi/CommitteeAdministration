...
{
    public class SubCriterionChangeOnePeriodBarChart : SubCriterionChangeOnePeriod
    {
        ...
        internal static Highcharts AbstractDrawChart(int subCriterionId, DateTime from, DateTime to)
        {
            ...
            var chart = ChartDrawer.DrawColumnChart("نمودار ستونی تغییرات درصد کارایی زیر معیار بر اساس زمان",
