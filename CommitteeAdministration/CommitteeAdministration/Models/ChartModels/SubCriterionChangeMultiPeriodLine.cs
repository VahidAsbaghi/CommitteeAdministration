...
{
    internal class SubCriterionChangeMultiPeriodLine : SubCriterionChangeMultiPeriod
    {
        ...
        internal static Highcharts AbstractDrawChart(int subCriterionId, List<DateTime> froms, List<DateTime> tos)
        {
            ...
            var chart = ChartDrawer.DrawLineChart("نمودار خطی تغییرات درصد کارایی زیرمعیار در چند محدوده زمانی", subCriterion.Subject, categories.ToArray(),
                "درصد", "", series.ToArray());
            return chart;
        }
    }
