...
{
    internal class IndicatorChangeMultiPeriodBar : IndicatorChangeMultiPeriod
    {
        ...
        internal static Highcharts AbstractDrawChart(int indicatorId, List<DateTime> froms, List<DateTime> tos)
        {
            ...
            var chart = ChartDrawer.DrawColumnChart("نمودار ستونی تغییرات مقدار واقعی شاخص بر اساس زمان", indicator.Subject, 
