...
,
            ...
            var indic_1_1_7 = new Indicator()
            {
                ...
                Subject = "تعداد نيروي انساني تحقيق و توسعه آن حوزه و  نسبت آن به‌کل نيروي انساني تحقيق و توسعه کشور‌ ",
                SubCriterion = criterion_1_1_Sub,
            };
...
,
            ...
            var indic_6_1_1 = new Indicator()
            {
                ...
                Subject = "تعداد دستاوردهای علمی منتج شده (تولید کالا/ ساخت تجهیزات/ ثبت اختراع/ مقالات ISI و ...) از پروژه‌های تحقیقاتی حمایت‌شده",
