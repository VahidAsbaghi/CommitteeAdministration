...
namespace CommitteeManagement.Repository.Data
{
    ...
    public class DbInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    {
        ...
        {
            //CreateProcedureOperation ss = new CreateProcedureOperation("Retrieve_criteria_committe",
            //    "SELECT * FROM CRITERION WHERE Id EXIST(SELECT CriterionId FROM (SELECT * FROM USER WHERE COMMITTEE_ID=@committeeId CRITERION_MODIFICATION)"); 
